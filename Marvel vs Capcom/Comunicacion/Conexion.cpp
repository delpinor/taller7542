...
int Conexion::enviar_mensaje(int socket, char* mensaje, int tam_mensaje){
...
int Conexion::recibir_mensaje(int socket, char* mensaje, int tam_mensaje){
	int received = 0;
	   int s = 0;
	   bool is_the_socket_valid = true;
	   ...
	   if (is_the_socket_valid) {
		   cout<<"recibir_mensajes, mensaje recibido: "<<*mensaje<<endl;
	      return received;
	   }
	   else {
	      return -1;
